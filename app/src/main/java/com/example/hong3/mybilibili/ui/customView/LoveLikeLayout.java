...
public class LoveLikeLayout extends RelativeLayout
{
    ...
    private void init()
    {
        ...
        Drawable one = getResources().getDrawable(R.mipmap.ic_live_like_01,null);
        Drawable two = getResources().getDrawable(R.mipmap.ic_live_like_02,null);
        Drawable three = getResources().getDrawable(R.mipmap.ic_live_like_03,null);
        Drawable four = getResources().getDrawable(R.mipmap.ic_live_like_04,null);
        Drawable five = getResources().getDrawable(R.mipmap.ic_live_like_05,null);
        drawables[0] = one;
        drawables[1] = two;
        drawables[2] = three;
        drawables[3] = four;
